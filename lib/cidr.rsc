...
:local ensureCidrReserved do={
    ...
    # bad
    /ip/firewall/address-list/add address=127.0.0.0/8 comment="Loopback" list=IP-CIDR_BAD
    /ip/firewall/address-list/add address=192.0.0.0/24 comment="IETF Protocol Assignments" list=IP-CIDR_BAD
    /ip/firewall/address-list/add address=192.0.2.0/24 comment="TEST-NET-1" list=IP-CIDR_BAD
    /ip/firewall/address-list/add address=198.51.100.0/24 comment="TEST-NET-2" list=IP-CIDR_BAD
    /ip/firewall/address-list/add address=203.0.113.0/24 comment="TEST-NET-3" list=IP-CIDR_BAD
    /ip/firewall/address-list/add address=240.0.0.0/4 comment="Reserved for future use" list=IP-CIDR_BAD
    # no global
